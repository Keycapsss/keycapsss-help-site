...
const Header = ({ siteTitle }) => (
  <header className="sticky top-0 z-40 flex flex-none bg-white border-b border-gray-200 lg:z-50 md:border-0">
    <div className="flex items-center flex-none w-20 md:w-60 xl:w-64">
      <Link to="/" className="w-10 overflow-hidden md:w-auto">
        <span className="sr-only">Tailwind CSS home page</span>
        <svg viewBox="0 0 247 31" className="w-auto h-6">
